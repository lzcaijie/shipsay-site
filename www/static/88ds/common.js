...
function login(){
	if ($.cookie('ss_username')) {
        document.writeln('<a href=\"javascript:show_bookcase();\" class=\"c_index_top\">'+$.cookie('ss_username') + '</a>');
    } else {
        document.writeln("<a class=\"login_topbtn c_index_login\" href=\"/login/\">登录</a><a href=\"/register/\" class=\"login_topbtn c_index_login\">注册</a>");
    }
}
//注册
...
var stTransform = function(d) {
    ...
    return (function(g) {
        ...
        for (var f = 0, e = g.childNodes.length; f < e; f++) {
