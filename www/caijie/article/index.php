...
<script>
   layui.use('table', function() {
       ...
       table.render({
           ...
           url: '../include/articlelist.php?do=show',
           cols: [
               [{
                   type: 'checkbox',
                   fixed: 'left'
   ...
   $('.search-btn-article').on('click', function() {
       ...
       layui.use('table', function() {
           ...
           table.render({
               elem: '#articlelist',
               limit: 20,
               url: '../include/articlelist.php?do=search&searchkey=' + searchkey,
               cols: [
                   [{
                       type: 'checkbox',
                       fixed: 'left'
   ...
   $('.display-btn').on('click', function() {
       ...
       layui.use('table', function() {
           ...
           table.render({
               elem: '#articlelist',
               limit: 20,
               url: '../include/articlelist.php?display=1',
               cols: [
                   [{
                       type: 'checkbox',
                       fixed: 'left'
