   ...
   <form class="layui-form layui-form-pane" method="POST" action="javascript:;">
       ...
       <div class="layui-form-item layui-form-text">
           ...
           <blockquote class="layui-elem-quote layui-text">
               格式: <span class="layui-bg-orange">需替换的内容</span><span class="layui-bg-red">♂船说cms♂</span><span class="layui-bg-orange">替换结果 </span>
               <br /><br />说明: (1)一行一条替换规则; (2)通配符 $$$$ 可代表任意字符; (3)替换结果留空,表示删除.
           </blockquote>
           <!-- <label class="layui-form-label" style="height: auto;">格式: <span class="layui-bg-orange">需替换的内容</span><span class="layui-bg-red">♂船说cms♂</span><span class="layui-bg-orange">替换结果 </span>( 替换结果留空,表示删除 )
               <br />一行一个,通配符 <span class="layui-bg-orange">$$$$</span> 可代表任意字符</label> -->
