   ...
   $('.save-btn-base').on('click', function() {
       $.ajax({
           ...
           data: {
               ...
               "txt_get_mode": $("input[name='txt_get_mode']:checked").val() || 0,
               ...
               "use_js": $("input[name='use_js']").is(':checked') ? 1 : 0,
               ...
               */
               ...
               "is_keywords": $("input[name='is_keywords']").is(':checked') ? 1 : 0,
               "keywords_num": $("input[name='keywords_num']").val(),
