...
-->
   <div class="layui-form-item">
       <label class="layui-form-label">正文JS输出</label>
       <div class="layui-input-inline switch-wd">
           <input type="checkbox" name="use_js" lay-skin="switch" lay-filter="use_js" lay-text="ON|OFF" <?php if($use_js==1)echo ' checked' ?>>
       </div>
       <div class="layui-form-mid layui-word-aux">阅读页正文内容使用Ajax请求输出</div>
   </div>
   <div class="layui-form-item">
   ...
   <div class="layui-form-item">
       ...
       <div class="layui-input-inline" style="width:400px;">
           <input type="text" name="site_url" autocomplete="off" value="<?=$site_url?>" class="layui-input">
       </div>
   ...
   <div class="layui-form-item">
       ...
       <div class="layui-input-inline">
           <input type="text" name="ss_newid" value="<?=$ss_newid?>" autocomplete="off" class="layui-input">
       </div>
   ...
   <div class="layui-form-item">
       ...
       <div class="layui-input-inline">
           <input type="text" name="ss_sourceid" value="<?=$ss_sourceid?>" autocomplete="off" class="layui-input">
       </div>
       <div class="layui-form-mid layui-word-aux">将刚才加5的ID还原, 写作: $id-5</div>
   </div>
