...
?>
<div class="container">
    <div class="layout" style="padding:18px 10px;">
        <h2 class="layout-tit">404 页面不存在</h2>
        <p style="color:#666;line-height:1.8;margin:0 0 14px;">你访问的页面可能已删除或地址错误。</p>
        <p style="margin:0 0 14px;">
            <a href="/" style="margin-right:12px;">返回首页</a>
            <a href="javascript:history.back();">返回上一页</a>
        </p>
        <form method="get" action="<?=$search_url_safe?>" style="max-width:520px;display:flex;gap:8px;">
