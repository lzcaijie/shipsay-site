...
<div class="container" style="padding:18px 10px;">
    <div class="section link" style="text-align:center;">
        ...
        <form method="get"<?php if ($search_url_raw !== ''): ?> action="<?=$search_url_attr?>"<?php endif; ?> style="max-width:520px;margin:0 auto;display:flex;gap:8px;"<?php if ($search_url_raw === ''): ?> onsubmit="return false;"<?php endif; ?>>
