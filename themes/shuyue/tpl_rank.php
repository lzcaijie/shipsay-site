...
<div class="container body-content">
    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="glyphicon glyphicon-th-large" aria-hidden="true"></span> <?=$current_title?>
            <?php if($rank_entry_raw !== ''): ?><a class="pull-right" href="<?=htmlspecialchars($rank_entry_raw, ENT_QUOTES, 'UTF-8')?>">聚合榜</a><?php endif; ?>
        </div>
