...
<div class="container body-content">
    ...
    <div class="panel panel-default" id="content">
        ...
        <div class="readPager">
            ...
            <a id="linkIndex" href="<?=!empty($index_url) ? $index_url : ((class_exists('Url') && method_exists('Url', 'index_url')) ? Url::index_url($articleid) : '#')?>"><i class="glyphicon glyphicon-th-list" aria-hidden="true"></i> 目 录</a>
