            ...
            <div class="row">
                ...
                <div class="col-sm-10 pl0">
                    ...
                    <div class="bookmore">
                        ...
                        <?php if($index_url_safe !== ''): ?><a class="btn btn-success" href="<?=$index_url_safe?>" rel="nofollow" type="button"><i class="glyphicon glyphicon-th-list" aria-hidden="true"></i> 章节目录</a><?php endif; ?>
                        <div class="clear"></div>
                    </div>
                    <hr/>
                    <p>
