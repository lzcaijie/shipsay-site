...
<div class="det-info g_row c_strong fs16 pr book-detail-x youdu-book-shell"><img src="<?=$esc($img_url_safe)?>" class="book-cover-blur hide" alt="<?=$esc($articlename_safe)?>"><div class="cover g_col_4"><span class="g_thumb"><img src="<?=$esc($img_url_safe)?>" width="300" height="400" alt="<?=$esc($articlename_safe)?>" loading="lazy"></span></div><div class="g_col_8 pr"><h1 class="mb15 lh1d2 oh"><?=$esc($articlename_safe)?></h1><div class="youdu-meta-grid"><strong><svg class="fs20 mr5"><use xlink:href="#i-pen"></use></svg><span><?=$esc($author_safe)?></span></strong><strong><svg class="fs20 mr5"><use xlink:href="#i-others"></use></svg><span><?=$esc($sortname_safe)?></span></strong><strong><svg class="fs20 mr5"><use xlink:href="#i-chapter"></use></svg><span><?=$esc($isfull_safe)?></span></strong><strong><svg class="fs20 mr5"><use xlink:href="#i-all"></use></svg><span><?=$esc($words_w_safe)?>万字</span></strong></div><div class="h112 mb15 det-abt lh1d8 c_strong fs16 hm-scroll"><p><?=$esc($intro_des_safe)?><br></p></div><div class="youdu-action-row"><?php if($first_url_safe !== ''): ?><a href="<?=$esc($first_url_safe)?>" title="开始阅读" class="bt">开始阅读</a><?php endif; ?><?php if($info_url_safe !== ''): ?><a href="<?=$esc($info_url_safe)?>" title="返回详情" class="bt alt">返回详情</a><?php endif; ?></div></div></div></div></div>
<div class="g_wrap pb30 pt10"><section class="youdu-section"><div class="youdu-section-head"><h3>最新12章</h3><span class="meta"><?php if($lastchapter_safe !== ''): ?>最新：<a href="<?=$esc($last_url_safe)?>"><?=$esc($lastchapter_safe)?></a><?php endif; ?><?php if($lastupdate_text !== ''): ?>&nbsp;&nbsp;<?=$esc($lastupdate_text)?><?php endif; ?></span></div><div class="youdu-chapter-grid"><?php foreach($latest_rows_safe as $row): ?><a href="<?=$esc($row['cid_url'])?>" title="<?=$esc($row['cname'])?>"><?=$esc($row['cname'])?></a><?php endforeach; ?></div></section><section class="youdu-section"><div class="youdu-section-head"><h3>章节目录（第<?=$pid_safe?>页）</h3><span class="meta"><?php if($chapters_safe > 0): ?>共<?=$chapters_safe?>章<?php endif; ?></span></div><ol class="youdu-preview-list"><?php foreach($list_arr_safe as $row): ?><li><a href="<?=$esc($row['cid_url'])?>" title="<?=$esc($row['cname'])?>"><?=$esc($row['cname'])?></a></li><?php endforeach; ?></ol><?php if($htmltitle_safe !== ''): ?><div class="youdu-page-box"><?=$htmltitle_safe?></div><?php endif; ?></section></div>
