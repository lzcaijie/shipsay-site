        ...
        <div class="det-info g_row c_strong fs16 pr book-detail-x youdu-book-shell">
            ...
            <div class="g_col_8 pr">
                ...
                <div class="youdu-meta-grid">
                    <strong><svg class="fs20 mr5"><use xlink:href="#i-author"></use></svg><span><?=$esc($author_safe)?></span></strong>
...
<div class="g_wrap det-con pb30 pt10" id="Contents">
    ...
    <section class="youdu-section">
        ...
        <div class="youdu-chapter-grid youdu-chapter-grid--compact"><?php foreach($preview_rows_safe as $row): ?><a href="<?=$esc($row['cid_url'])?>" title="<?=$esc($articlename_safe . ' ' . $row['cname'])?>"><?=$esc($row['cname'])?></a><?php endforeach; ?></div>
