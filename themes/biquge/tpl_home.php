...
<head>
<meta charset="UTF-8">
    <title><?=SITE_NAME?>_<?=SITE_NAME?>网_无弹窗小说阅读网</title>
...
<div class="container flex flex-wrap">
    <div class="border3 commend flex flex-between">
        <?php foreach($commend as $k => $v): ?><?php if($k < 4):?>
            <div class="outdiv">
                <a href="<?=$v['info_url']?>"><img class="lazy" src="/static/<?=$theme_dir?>/nocover.jpg" data-original="<?=$v['img_url']?>" alt="<?=$v['articlename']?>" onerror="this.src='/static/<?=$theme_dir?>/nocover.jpg';this.onerror=null;"></a>
                <div>
