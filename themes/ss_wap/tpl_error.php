...
<div class="index-head">
  <h1><a href="/" class="logo"><?=SITE_NAME?></a></h1>
  <a href="/bookcase/" rel="nofollow" class="btn">书架</a>
  <a href="<?=$full_allbooks_url?>" rel="nofollow" class="btn">完本</a>
  <a href="javascript:;" onclick="toggleSort();" rel="nofollow" class="btn">排行</a>
</div>
...
<div class="search">
  <?php if (is_file(__THEME_DIR__ . '/tpl_search_form.php')) { require_once __THEME_DIR__ . '/tpl_search_form.php'; } ?>
</div>
