...
$full_allbooks_url_safe = !empty($full_allbooks_url) ? $full_allbooks_url : ('/quanben' . (isset($allbooks_url) ? $allbooks_url : '/classify/'));
$canonical_url_safe = (isset($site_url) ? $site_url : '') . (isset($_SERVER['REQUEST_URI']) ? $_SERVER['REQUEST_URI'] : '/');
?>
...
<link rel="canonical" href="<?=$canonical_url_safe?>">
...
<link rel="stylesheet" href="/static/2025/css/2025.css?v=20221207" />
</head>
<body>
...
<div class="header-m-center"><?= $tag ?></div>
...
<li><a href="">小说专题</a></li>
<li class="active"><?= $tag ?>小说</li>
</ol>
<div class="list-index-2">
<div class="title"><h2><?= $tag ?>小说</h2><span></span></div>
<?php if (is_array($tagarr)) : ?>
...
<div class="pages">
<ul class="pagination" id="pagelink"><li class="first"><?=$jump_html ?></li></ul>
<div class="cf"></div>
</div>
...
<script src="/static/2025/js/jquery.min.js?v=20221207"></script>
<script src="/static/2025/js/2025.js?v=20221207"></script>
